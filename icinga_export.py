...
def view_services():
    cursor = dbc.cursor()
    cursor.execute("SELECT icinga_hosts.display_name AS host_name, icinga_services.display_name as service_name, icinga_servicestatus.current_state as service_state "
